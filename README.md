...
The objective of this project is to analyze and visualize key business metrics such as sales performance, customer preferences, and outlet efficiency. Using an interactive dashboard, stakeholders can easily track KPIs and identify trends across different product categories, outlet types, and locations.
...
💰 Total Sales
Represents the overall revenue generated from all items sold.

📈 Average Sales
Indicates the average revenue generated per transaction.

📦 Number of Items Sold
Shows the total count of items sold across all categories.

⭐ Average Rating
Reflects the average customer satisfaction rating for sold items.
